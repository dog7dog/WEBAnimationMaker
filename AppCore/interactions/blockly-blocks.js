...
// 動きの緩急。cubic-bezier / linear() はそのままCSSに書ける形にしてある。
//   行き過ぎて戻る … 目標を少し超えてから戻る（ポップな印象）
//   ばね           … 減衰するばね y(t)=1-e^(-6.5t)cos(11.5t) を22点で近似
//   勢いよく飛ぶ   … いったん引いてから飛び出す
const MLC_EASING_OPTIONS = [
  ...
  ['一定速度', 'linear'],
  ['行き過ぎて戻る', 'cubic-bezier(0.34, 1.56, 0.64, 1)'],
  ['勢いよく飛び出す', 'cubic-bezier(0.36, 0, 0.66, -0.56)'],
  ['ばねのように揺れて止まる',
    'linear(0, 0.355, 0.722, 0.999, 1.152, 1.197, 1.17, 1.11, 1.048, 1.001, 0.974,'
    + ' 0.967, 0.971, 0.981, 0.992, 1, 1.004, 1.006, 1.005, 1.003, 1.001, 1, 1)'],
  ['カクカク（5段階）', 'steps(5, end)']
];
